...
int search(FILE* inptr)
{
    ...
    // if no_JPEGs_found switch is negative, return the location of block containing first JPEG magic numbers
    if (JPEGs_found == 0)
    {
        //printf("JPEGs found! Location start at block: ");
        return location_search;
    }
    // if no_JPEGs_found switch is positive, return the location of EOF   
    else
    {
        //printf("No JPEGs found. EOF at block:");
        return location_search;
    };
};
